...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-router-dom/node_modules/react-router-dom/HashRouter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-router-dom/node_modules/react-router-dom/HashRouter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-router-dom/node_modules/react-router-dom/</a> &#187; HashRouter.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function HashRouter() {</span>
<span class="cstat-no" title="statement not covered" >    var _temp, _this, _ret;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, HashRouter);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = (0, _createHashHistory2.default)(_this.props), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
  HashRouter.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
