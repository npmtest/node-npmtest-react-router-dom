...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-router-dom/node_modules/react-router-dom/BrowserRouter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-router-dom/node_modules/react-router-dom/BrowserRouter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-router-dom/node_modules/react-router-dom/</a> &#187; BrowserRouter.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function BrowserRouter() {</span>
<span class="cstat-no" title="statement not covered" >    var _temp, _this, _ret;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, BrowserRouter);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = (0, _createBrowserHistory2.default)(_this.props), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
  BrowserRouter.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
<span class="cstat-no" title="statement not covered" >    return _react2.default.createElement(_reactRouter.Router, { history: this.history, children: this.props.children });</span>
  };
&nbsp;
